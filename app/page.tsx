export default function HomePage() {
  const products = ["biodegradable kitchen sponges","reusable beeswax food wraps","compostable trash bags"];
    ...
    <main>
      ...
      <section style={{ background: "var(--primary)", color: "#fff", padding: "6rem 2rem", textAlign: "center" }}>
        <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, marginBottom: "1rem" }}>
          Eco-Friendly Essentials for Every Home
        </h1>
      ...
      <section style={{ padding: "4rem 2rem", maxWidth: "1100px", margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "2rem", fontWeight: 700, marginBottom: "3rem" }}>Why EcoEssentials?</h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem" }}>
          {["Premium Quality", "Fast Shipping", "100% Satisfaction Guarantee"].map((f) => (
            <div key={f} style={{ padding: "2rem", border: "1px solid #eee", borderRadius: "12px", textAlign: "center" }}>
              ...
              <p style={{ color: "#666" }}>We stand behind every product we sell, made for environmentally conscious consumers, primarily aged 25-45, interested in sustainable living.</p>
            </div>
          ))}
        </div>
      </section>
            ...
            {products.map((p: string, i: number) => (
              <div key={i} style={{ background: "#fff", border: "1px solid #eee", borderRadius: "12px", overflow: "hidden" }}>
                ...
                <div style={{ padding: "1.5rem" }}>
                  ...
                  <p style={{ color: "#666", marginBottom: "1rem", fontSize: "0.9rem" }}>Perfect for environmentally conscious consumers, primarily aged 25-45, interested in sustainable living</p>
