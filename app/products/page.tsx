export default function ProductsPage() {
  ...
  return (
    <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "3rem 2rem" }}>
      ...
      <p style={{ color: "#666", marginBottom: "3rem" }}>Curated eco-friendly home essentials products for environmentally conscious consumers, primarily aged 25-45, interested in sustainable living</p>
        ...
        {products.map((p: string, i: number) => (
          <div key={i} style={{ border: "1px solid #eee", borderRadius: "12px", overflow: "hidden" }}>
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              <p style={{ color: "#666", fontSize: "0.875rem", marginBottom: "1rem" }}>High quality eco-friendly home essentials product. Loved by environmentally conscious consumers, primarily aged 25-45, interested in sustainable living.</p>
